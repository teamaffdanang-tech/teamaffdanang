...
export const importedDataset: SeedDataset = {
  ...
  products: [
    ...
    },
    {
      ...
      categorySlugs: ['bags-cases', 'mystery-sets'],
    ...
    },
    {
      ...
      description: 'You might find the following Japanese brands included in your Back To School set:\nPentel, Kuretake, Pilot, Uni, Artline, Zebra, Kokuyo, MUJI\nStationery items included but not only: Washi Tape, Brush Pen, Gel Pen, Sticky Note, Sticker, Glue Tape, Eraser\n* This mystery set is listed at 18.55 USD, however, we want to remind you to use the 30% coupon "BTS2026" to get it for 12.99USD. 💸* This flash sale has limited number of sets available. We will stop selling after it is gone.* This is most likely the best bang for your buck this season.\nProbability:\n15-16 items: 60%17-20 items: 35%Limited/special edition/co-branded: 5%',
      categorySlugs: ['bags-cases', 'mystery-sets'],
