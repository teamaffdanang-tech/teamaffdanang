          ...
          fields: [
            ...
            },
            {
              ...
              options: [
                ...
                { label: "Editor's Choice", value: 'editor-choice' },
                { label: 'Best Value', value: 'best-value' },
                { label: 'Best Premium', value: 'best-premium' },
                { label: 'Best Everyday', value: 'best-everyday' },
                { label: 'Best Travel', value: 'best-travel' },
              ],
              defaultValue: 'none',
            },
          ],
