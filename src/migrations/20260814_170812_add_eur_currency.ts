...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   ALTER TYPE "public"."enum_products_retailer_links_currency" ADD VALUE 'EUR';
  ALTER TYPE "public"."enum__products_v_version_retailer_links_currency" ADD VALUE 'EUR';`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_products_retailer_links_currency" AS ENUM('USD', 'HKD', 'GBP');
  ...
  CREATE TYPE "public"."enum__products_v_version_retailer_links_currency" AS ENUM('USD', 'HKD', 'GBP');
