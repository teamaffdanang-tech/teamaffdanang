...
- **Coupon Code chưa có chỗ trong schema:** user đưa "DNAFFTEAM" cho stationerypal.com nhưng CHƯA xác nhận gắn vào Retailer (coupon toàn site) hay Product (coupon riêng sản phẩm) — cần hỏi lại, chưa thêm field.
